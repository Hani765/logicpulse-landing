...
export const HowItWorks = () => {
  ...
  return (
    ...
    >
      ...
      >
        Discover how our platform operates seamlessly to optimize your affiliate experience. We provide detailed steps to streamline your workflow and maximize your earnings potential.
      </motion.p>
